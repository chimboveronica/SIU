$(document).ready(
        function () {
            ...
            var anchoOriginal = $('.bloque-imagenes').attr('width');
            anchoOriginal = anchoOriginal ? anchoOriginal.split(' ').slice(-1)[0] : '';
            ...
            function carrusel() {
                ...
                /*
                margenTop = $('.bloque-imagenes').attr('margin-left');
                margenTop = margenTop? margenTop.split(' ').slice(-1)[0] : '';  /*
              
                
                 ancho=$('.bloque-imagenes').css('width');;
                 ancho=ancho.split('p');
                 */
                ancho = $('.bloque-imagenes').attr('width');
                ancho = ancho ? ancho.split(' ').slice(-1)[0] : '';
